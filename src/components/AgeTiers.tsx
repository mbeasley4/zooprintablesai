const animals: { emoji: string; name: string; letter: string; href: string | null }[] = [
  { emoji: "🐘", name: "African Elephant",   letter: "A", href: "/downloads/ZooExplorers_African_Elephant.pdf" },
  { emoji: "🐊", name: "Alligator",          letter: "A", href: null },
  { emoji: "🐦", name: "Albatross",          letter: "A", href: null },
  { emoji: "🦅", name: "Amur Leopard",       letter: "A", href: "/downloads/ZooExplorers_Amur_Leopard.pdf" },
  ...
  { emoji: "🐳", name: "Blue Whale",         letter: "B", href: "/downloads/ZooExplorers_Blue_Whale.pdf" },
  { emoji: "🐬", name: "Bottlenose Dolphin", letter: "B", href: null },
  ...
  { emoji: "🐊", name: "Crocodile",          letter: "C", href: null },
  { emoji: "🐕", name: "Dhole",              letter: "D", href: "/downloads/ZooExplorers_Dhole.pdf" },
  ...
  { emoji: "🐈", name: "Fishing Cat",        letter: "F", href: "/downloads/ZooExplorers_Fishing_Cat.pdf" },
  ...
  { emoji: "🦈", name: "Great White Shark",  letter: "G", href: null },
  ...
  { emoji: "🦋", name: "Monarch Butterfly",  letter: "M", href: null },
  ...
  { emoji: "🐻‍❄️", name: "Polar Bear",      letter: "P", href: null },
  ...
  { emoji: "🦏", name: "White Rhino",        letter: "W", href: null },
